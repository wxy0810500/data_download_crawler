...
def fetchData(year, yRange):
    print("start " + yRange)
    # 设置下载路径如果不存在，新建
    downloadFilePath = '/home/ubuntu/GHDDI/download/integrity/exp_models/' + year
    ...
    # 设置浏览器需要打开的url
    url = 'https://integrity.clarivate.com/integrity/xmlxsl/exp_models_form_pkg.expModelsForm'
    urlEntry = 'https://www.google.com'
    ck1 = {'name': 'igr_user', 'value': '613132923M460140%|ITGR|', 'domain': '.clarivate.com',
    ...
    sleep(2)
    # 设置Key1
    browser.find_element_by_id('div_par_EMO1').click()
    sleep(1)
    browser.find_element_by_id('EMO_AVAILABLE_SINCE').click()
    sleep(1)

    # 设置query1
    q1 = browser.find_element_by_id('p_val_EMO1')
    q1.clear()
    q1.send_keys(yRange)
    sleep(1)
