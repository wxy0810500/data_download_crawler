...
# 1. 点击lookup
# 2. 切换到lookup窗口
# 3. 从Lookup窗口中,依次找到  //center//imput[2*i -1]的input框,并从value属性中提取id;
#     再找到 //center//a[2*i] 的标签,其text为name
# 4.click input框
# 5.click ok按钮 //center//tr[5]//input
# 6.close lookup窗口,切回到原有窗口
...
def doFetchData(browser, n):
    ...
    #点击lookup
    browser.find_element_by_xpath('//table[2]//table[2]//a/img').click()
...
def fetchData(n):
    downloadFilePath = '/home/ubuntu/GHDDI/download/integrity/drug-gateway'
