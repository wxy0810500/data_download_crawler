...
def doFetchData(year, yRange, browser):
    # 设置浏览器需要打开的url
    url = 'https://integrity.clarivate.com/integrity/xmlxsl/pk_prod_form.xml_prod_form_pr'
    urlEntry = 'https://www.google.com'
    ck1 = {'name': 'igr_user', 'value': '1142475595M460140%|ITGR|', 'domain': '.clarivate.com',
    ...
    # 设置Key1:时间
    browser.find_element_by_id('div_par_PRO1').click()
    sleep(1)
    browser.find_element_by_id('PRO_AVAILABLE_SINCE').click()
    sleep(1)

    # 设置query1
    q2 = browser.find_element_by_id('p_val_PRO1')
    q2.clear()
    q2.send_keys(yRange)
    sleep(1)
    ...
    # 提取总数
    numberText = browser.find_element_by_xpath('/html/body/table[2]/tbody/tr/td/table/tbody/tr[2]/td[3]/b').text
...
def fetchData(year, yRange):
    print("start :" + yRange)
    downloadFilePath = '/home/ubuntu/GHDDI/download/integrity/drugs/{}'.format(year)
