...
# 初始化根节点
rootNode = TreeNode('https://integrity.clarivate.com/integrity/xmlxsl/pk_hierar_tree.hierarchyTreeEAToxicity?p_parent_id=0&p_action=click&p_element=p_val_EXP1#sn', 'TOXICITY/ADVERSE EVENTS', 0, 0)
...
if __name__ == "__main__":
    ...
    if len(nodeDict) != 0:
        filePath = '/home/ubuntu/GHDDI/download/integrity/experimentalActivitesToxicityTree.csv'
