...
def getFirstLevelInfo(browser):
    url = 'https://integrity.clarivate.com/integrity/xmlxsl/pk_browse_index.xml_lov_body?p_type=H&p_subsystem=TAR&p_seleccio=TARTARNAME&p_loc=p_val_TAR1&p_lletra=0-9&p_from=TARTARNAME&p_first=yes#'
    browser.get(url)
    sleep(2)
...
if __name__ == "__main__":
    ...
    if len(nodeDict) != 0:
        filePath = '/home/ubuntu/GHDDI/download/integrity/target/classification_tree.csv'
